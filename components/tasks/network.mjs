...
import { add, get, getTaskById, update, deleted} from './controller.mjs';
...
const controller = { add, get, getTaskById, update, deleted}; // Objeto que contiene las funciones de controlador importadas
